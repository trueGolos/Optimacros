...
if (count($errors) === 0)
{
    ...
    $forest = (new Forest())->generateForestFromCsv(csv_file: $csv_file,
        internated_strings: $internated_strings);

    $json_builder = new TreeJsonBuilder(filename: $output_json_file,
        forest: $forest,
        internate_strings: $internated_strings);
